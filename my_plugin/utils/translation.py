...
def ntr(
        translation_key: str, *args, language: Optional[str] = None, allow_failure: bool = True,
        default_fallback: Optional[MessageText] = None, log_error_message: bool = True, **kwargs
) -> MessageText:
    try:
        return psi.tr(
        ...
        try:
            ...
            return psi.tr(
                translation_key, *args, language='en_us', allow_failure=False, **kwargs
            )
        except (KeyError, ValueError):
            languages = []
